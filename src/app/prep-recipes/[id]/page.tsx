...
export default function EditPrepRecipePage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    // Fetch prep recipe with items
    const { data: recipe, error: fetchError } = await supabase
      .from('prep_recipes')
      .select('*, items:prep_recipe_items(*, ingredient:ingredients(name))')
      .eq('id', id)
      .single()
  ...
  if (loading) {
    return (
      <AppLayout title="仕込みレシピ編集" orgName={orgName}>
